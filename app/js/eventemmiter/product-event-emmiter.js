...
class ParentProductAppEventEmmiter {
    constructor() {
        events.EventEmitter.call(this);
    }
}

// 利用 util 模块使 ParentProductAppEventEmmiter 继承 EventEmmiter
util.inherits(ParentProductAppEventEmmiter, events.EventEmitter);

class ProductAppEventEmmiter extends ParentProductAppEventEmmiter {
    constructor() {
        super();
    }
